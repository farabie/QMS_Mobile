...
class FormAuditPausePage extends StatefulWidget {
  ...
  @override
  State<FormAuditPausePage> createState() => _FormAuditPausePageState();
}

class _FormAuditPausePageState extends State<FormAuditPausePage> {
                    ...
                    if (selectedCableType != null &&
                      ...
                      try {
                        ...
                        final response = await ApiService()
                            .fetchAuditByTicket2(widget.formattedIdAudit);
      ...
      child: Column(
        ...
        children: [
          ...
          InputWidget.dropDown(
            ...
            'Search type cable/environment Audit',
          ),
          const Gap(6),
          InputWidget.dropDown(
            'Category of Audit',
