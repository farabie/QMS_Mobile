...
class DetailAuditPage extends StatefulWidget {
  final String ticketNumber;
  final String formattedIdAudit;

  const DetailAuditPage({
    super.key,
  ...
  @override
  _DetailAuditPageState createState() => _DetailAuditPageState();
}

class _DetailAuditPageState extends State<DetailAuditPage> {
            ...
            child: DButtonBorder(
              onClick: () async {
                ...
                try {
                  ...
                  final qmsTicketNumber = widget.formattedIdAudit;
