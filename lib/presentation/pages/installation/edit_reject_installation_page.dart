...
class EditRejectInstallationPage extends StatefulWidget {
  const EditRejectInstallationPage({super.key});

  @override
  State<EditRejectInstallationPage> createState() =>
      _EditRejectInstallationPageState();
}

class _EditRejectInstallationPageState
    extends State<EditRejectInstallationPage> {
  String? ticketNumber;
  int? stepNumber;
  int? imageLength;
  String? qmsId;
  ...
  void didChangeDependencies() {
    ...
    if (args != null) {
      ...
      if (photoUrls!.isEmpty && documentations.isEmpty) {
        ...
        bottomNavigationBar: Container(
          ...
          child: Center(
            child: Padding(
              ...
              child: DButtonFlat(
                onClick: () async {
                  int currentPhotoCount = isPhotoUrlMode
                      ? photoUrls!.length
                      : documentations.length;

                  print('Current photo count: $currentPhotoCount');
  ...
  void showConfirmationDialog(BuildContext context,
      {String? updateDescription, List<XFile>? photosToUpload}) {
    showDialog(
      context: context,
  ...
  Widget formEditRejectInstallation() {
    return Container(
      decoration: BoxDecoration(
        color: AppColor.whiteColor,
