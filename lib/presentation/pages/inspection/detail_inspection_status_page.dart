...
class DetailInspectionStatusPage extends StatefulWidget {
  final String dmsTicket;
  final String qmsTicket;

  const DetailInspectionStatusPage({
    super.key,
  ...
  @override
  _DetailInspectionStatusPageState createState() =>
      _DetailInspectionStatusPageState();
}

class _DetailInspectionStatusPageState
    extends State<DetailInspectionStatusPage> {
  ...
  void initState() {
    ...
    edtQmsInspectionTicketNumber =
        TextEditingController(text: widget.qmsTicket);
  }
