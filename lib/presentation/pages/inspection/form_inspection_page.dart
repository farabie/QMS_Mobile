...
class FormInspectionPage extends StatefulWidget {
  ...
  @override
  State<FormInspectionPage> createState() => _FormInspectionPageState();
}

class _FormInspectionPageState extends State<FormInspectionPage> {
      ...
      child: Column(
        ...
        children: [
          ...
          InputWidget.dropDown(
            ...
            'Search type cable/enviroment Inspection',
          ),
          const Gap(6),
          InputWidget.dropDown(
